...
\item[\param{qf}] Quality flag for the \keyword{LOWCOH} calculation.  Values
  mark the standard high-power/high-coherence case, the low-coherence case, and
  bins where the implemented conditions do not allow a useful
  intrinsic-coherence estimate.
\end{description}
