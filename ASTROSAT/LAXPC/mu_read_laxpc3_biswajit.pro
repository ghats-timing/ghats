pro mu_read_laxpc3_biswajit,unit,laxpc_layer,tag,rdata,np,channels,selected,jmeta,tres,tres_fft, $
...
if(tag ne canale_corrente3) then begin
	...
	fxbreadm,unit,[time_unit,picol],tempi3,energy3   ; energy here is event word
