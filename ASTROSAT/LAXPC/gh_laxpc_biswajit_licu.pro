...
;
   ...
   for j=0,nmetafiles-1 do begin
	 ...
	 ENDCASE
	 ;=====** write ascii licu
	 xascii = fltarr(n_elements(rdata))
	 mu,reb,xascii,rdata,rdata,1024,dumdum,yascii,ydum
	 for iascii=0:n_elements(yascii) do begin
		 printf,13,dumdum,yascii
	 endfor
...
close,/all
fine_dps:
print,'gh_laxpc_biswajit_licu: normal termination'
;beep
;
