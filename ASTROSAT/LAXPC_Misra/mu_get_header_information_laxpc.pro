pro mu_get_header_information_laxpc,filenames,types,tstarts,tends,tress, $
         valtimes1,valtimes2, $
...
; If the date is in old format, cosntruct it in the new one
      ...
      tress(i,j)   = timedel
;=============================================================================================
; GTI section removed 04-Oct-2017 as GTIs are external and ext #2 contains response filenames
;=============================================================================================
;
