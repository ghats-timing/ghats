pro mu_read_laxpc3,unit,laxpc_unit,laxpc_layer,tag,rdata,np,channels,selected,jmeta,tres,tres_fft, $
...
if(tag ne canale_corrente1) then begin
	...
	fxbreadm,unit,[time_unit,picol,laxpc,layer],tempi3,energy3,lax,lay
