...
;   - 05/04/2009 modified by Tomaso Belloni (INAF-OAB): no rendering warning
;                                                       and oplot transformation
;
;-
; LICENCE:
...
;-
;
pro MUPLOTERR, x, y, y_error, x_error, psym=psym, type=type, $
